...
const Collection = () => {
    const { apiproducts, search, showSearch } = useContext(ShopContext);
    ...
    const applyFilter = () => {
        ...
        let productsCopy = apiproducts.slice();
    ...
    const sortProduct = (e) => {
        let fProduct = filterProducts.slice()
    ...
    useEffect(() => {
        applyFilter()
    }, [category, subCategory, search, showSearch, apiproducts])
